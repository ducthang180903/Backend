...
const createThanhToan = async (data) => {
    try {
        await ThanhToan.create(data); // Tạo mới bản ghi thanh toán với dữ liệu truyền vào
        return { message: 'Thanh toán thành công.', status: 200 }; // Trả về thanh toán mới tạo
    } catch (error) {
